...
(
  ...
  const getDatasetLabel = (dataset: { label?: string }, index: number) =>
  ...
  (dataset) =>
    ...
    const chartData = data.labels
      ...
      .map((label, index) => ({
        name: label,
        ...Object.fromEntries(
  validDatasets.map((dataset, dIndex) => [
    getDatasetLabel(dataset, dIndex),
          ...
          return (
            <RechartsCore.BarChart data={chartData}>
              ...
              {validDatasets.map((dataset, index) => (
                <RechartsCore.Bar
                  key={getDatasetLabel(dataset, index)}
                  dataKey={getDatasetLabel(dataset, index)}
                  fill={
